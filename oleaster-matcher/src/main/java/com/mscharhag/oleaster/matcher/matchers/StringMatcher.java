...
public class StringMatcher extends ObjectMatcher<String> {
	...
	/**
	 * Checks if the stored {@code String} matches a regular expression.
	 * <p>This method is similar to {@link #toMatch(Pattern)} except it takes the regular expression as
	 * String. The passed String {@code pattern} will be compiled to a {@link Pattern} using
	 ...
	 * 		<li>the stored {@code String} is {@code null}</li>
	 * </ul>
	 * @throws IllegalArgumentException if {@code end} is {@code null}.
	 ...
	 * 		<li>the stored {@code String} is {@code null}</li>
	 * </ul>
	 * @throws IllegalArgumentException if {@code substr} is {@code null}.
