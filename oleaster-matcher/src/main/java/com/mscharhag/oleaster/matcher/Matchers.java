...
public class Matchers {
	...
	/**
	 * Creates a new {@link IntegerNumberMatcher} initialized with
	...
	/**
	 * Creates a new {@link FloatingPointNumberMatcher} initialized with
	 * the passed {@code value}.
	 ...
	 * </pre>
	 * @see FloatingPointNumberMatcher
	 * @param value the value that should be checked
	...
	/**
	 * Creates a new {@link ExceptionMatcher} initialized with
	 * the passed {@code CodeBlock}.
	 * <p>The returned matcher can be used to check if the passed {@code CodeBlock} throw an exception.
	 * {@link ExceptionMatcher.CodeBlock} is a functional interface that can be
	...
	/**
	 * Creates a new {@link BooleanMatcher} initialized with
	 * the passed {@code value}.
	...
	/**
	 * Creates a new {@link StringMatcher} initialized with
	 * the passed {@code value}.
	...
	/**
	 * Creates a new {@link CollectionMatcher} initialized with
	 * the passed {@code value}.
	...
	/**
	 * Creates a new {@link MapMatcher} initialized with
	 * the passed {@code value}.
	...
	/**
	 * Creates a new {@link ObjectMatcher} initialized with
	 * the passed {@code value}.
